  ...
  return new Promise((resolve,reject) => {
    ...
    const req = https.request({
      ...
      headers:{
        ...
        'User-Agent':'Nexa-AI-Local-Bridge/1.4.0',
        'Connection':'close',
...
function requestCurl(method, urlValue, token, body, timeoutMs = DEFAULT_TIMEOUT_MS) {
  return new Promise((resolve,reject)=>{
    ...
    const config=[
      ...
      `header = ${quoteCurlConfigValue('User-Agent: Nexa-AI-Local-Bridge/1.4.0')}`,
